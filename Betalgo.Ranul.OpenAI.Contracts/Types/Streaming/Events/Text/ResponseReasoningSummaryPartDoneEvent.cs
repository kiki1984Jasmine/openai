...
/// <summary>
///     Emitted when a reasoning summary part is finalized.
///     <see href="https://platform.openai.com/docs/api-reference/responses-streaming">OpenAI API documentation</see>.
///     <see href="https://github.com/betalgo/openai/blob/master/Docs/openapi-split/components/schemas/responsereasoningsummarypartdoneevent.yml">
///         Source Definition
///     </see>
/// </summary>
public sealed class ResponseReasoningSummaryPartDoneEvent : IResponseStreamEvent
{
    /// <summary>
    ...
    public string Type => ResponseStreamEventType.ReasoningSummaryPartDone;
